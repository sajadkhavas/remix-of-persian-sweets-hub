...
export const PRODUCT_CATEGORIES = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "کوکی‌های غیر یخچالی با بسته‌بندی محافظ به سراسر ایران ارسال می‌شوند.",
      },
    ],
    seoContent: seoContent(
      {
        title: "کوکی تازه برای پذیرایی روزمره",
        body: "دسته کوکی‌ها برای محصولاتی است که بافت نرم، طعم آشنا و امکان ارسال ساده‌تری دارند. اطلاعات مواد اولیه، آلرژن و شرایط نگهداری در صفحه محصول درج می‌شود.",
      },
      {
        title: "راهنمای انتخاب کوکی",
        body: "اگر محصولی می‌خواهید که هم برای عصرانه مناسب باشد و هم برای هدیه کوچک، کوکی شکلاتی گردویی انتخاب خوش‌طعم و مطمئنی است.",
      },
      {
        title: "نکته نگهداری",
    ...
    faqs: [
      {
        ...
        answer:
          "کیک‌های یخچالی برای حفظ کیفیت فقط در تهران و کرج ارسال می‌شوند و جزئیات ارسال در صفحه محصول نوشته شده است.",
      },
      {
    ...
    seoContent: seoContent(
      {
        ...
        body: "کیک‌ها نسبت به کوکی و شیرینی خشک حساس‌تر هستند و شرایط نگهداری و ارسال آن‌ها باید پیش از سفارش بررسی شود.",
      },
      {
        title: "راهنمای انتخاب کیک",
        body: "برای دورهمی‌های کوچک، کیک خیس شکلاتی با بافت مرطوب و طعم کاکائویی انتخاب اصلی این دسته است.",
      },
      {
        title: "نگهداری کیک",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "بله، شیرینی‌های خشک غیر یخچالی با بسته‌بندی محافظ برای ارسال به سراسر ایران آماده می‌شوند.",
      },
    ],
    seoContent: seoContent(
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "محصولات رژیمی به کجا ارسال می‌شوند؟",
        answer: "محصولات رژیمی غیر یخچالی با بسته‌بندی محافظ به سراسر ایران ارسال می‌شوند.",
      },
    ],
    seoContent: seoContent(
      {
  ...
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "باکس هدیه وینیمی ترکیبی از محصولات منتخب را در یک بسته‌بندی مناسب هدیه کنار هم قرار می‌دهد و جزئیات آن در صفحه محصول نوشته می‌شود.",
      },
      {
    ...
    seoContent: seoContent(
      ...
      },
      {
        ...
        body: "محتوای باکس، وزن تقریبی، آلرژن‌ها و شرایط نگهداری در صفحه محصول نوشته می‌شود.",
      },
    ),
