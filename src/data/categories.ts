...
export const PRODUCT_CATEGORIES = [
  ...
  },
  {
    ...
    seoDescription:
      "خرید آنلاین محصولات رژیمی وینیمی مانند کوکی رژیمی و کوکی مناسب دیابتی‌ها با اطلاعات مواد اولیه و آلرژن‌ها.",
    visual: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "محصولات فعلی این دسته شامل کوکی رژیمی و کوکی مختص دیابتی است. موجودی و مشخصات دقیق در کارت و صفحه هر محصول نمایش داده می‌شود.",
      },
    ],
    seoContent: {
      introduction: {
