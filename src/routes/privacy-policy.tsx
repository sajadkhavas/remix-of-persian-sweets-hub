...
export const Route = createFileRoute("/privacy-policy")({
  head: () =>
    buildSeo({
      ...
      description:
        "سیاست حریم خصوصی وینیمی بیکری — نحوه جمع‌آوری و استفاده از اطلاعات شخصی.",
      path: "/privacy-policy",
    }),
      ...
      <RevealOnScroll>
        <article className="mx-auto max-w-3xl rounded-3xl bg-white p-8 md:p-10 border border-border">
          ...
          <div className="legal-content mt-6">
            <h2>مقدمه</h2>
            <p>
              {SITE.brandFa} به حریم خصوصی کاربران احترام می‌گذارد. این سند نحوه جمع‌آوری،
              استفاده و محافظت از اطلاعات شما را توضیح می‌دهد.
            </p>

            <h2>۱. اطلاعاتی که جمع‌آوری می‌کنیم</h2>
            <ul>
              <li><strong>اطلاعات شخصی:</strong> نام، شماره موبایل، آدرس و کد پستی — صرفاً برای پردازش سفارش.</li>
              <li><strong>اطلاعات مرور:</strong> صفحات بازدیدشده و زمان بازدید — برای بهبود تجربه کاربری.</li>
              <li><strong>اطلاعات پرداخت:</strong> مستقیماً توسط درگاه بانکی پردازش می‌شود و ما به آن دسترسی نداریم.</li>
            </ul>
            ...
            <p>
              سایت از کوکی‌های ضروری برای عملکرد سبد خرید استفاده می‌کند. این کوکی‌ها
              اطلاعات شخصی ذخیره نمی‌کنند.
            </p>
