...
const CATEGORY_MAP: Record<Category, { name: string; intro: string }> = {
  ...
  "dry-sweets": {
    name: "شیرینی خشک",
    intro:
      "شیرینی خشک سنتی ایرانی شامل باقلوا، سوهان و نان نخودچی؛ ماندگاری بالا و مناسب ارسال.",
  },
  "gift-boxes": {
    name: "جعبه هدیه",
    intro:
      "جعبه‌های هدیه شکیل با ترکیب منتخب از کوکی و شیرینی، مناسب مناسبت‌ها و هدیه سازمانی.",
  },
  diet: {
    name: "محصولات رژیمی",
    intro:
      "کوکی و شیرینی بدون شکر یا با شیرین‌کننده طبیعی، مناسب رژیم و کنترل وزن.",
  },
};
