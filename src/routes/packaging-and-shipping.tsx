...
function PackagingPage() {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer: "پست پیشتاز برای سراسر ایران و پیک تیپاکس برای تهران و کرج و برخی مراکز استان.",
    },
    {
      question: "زمان تحویل چقدر است؟",
      answer: "بین ۱ تا ۵ روز کاری بسته به شهر مقصد؛ زمان دقیق در صفحه هر شهر آمده است.",
    },
    {
  ...
  return (
    <div>
      ...
      <AnswerBlock
        ...
        detail={
          <p>
            هر محصول ابتدا در بسته‌بندی مخصوص خودش قرار می‌گیرد، سپس داخل جعبه اصلی با پد فوم و لایه
            حبابی محافظت می‌شود. تمام سفارش‌ها قبل از تحویل به پست، کنترل کیفی می‌شوند.
          </p>
        }
      />
