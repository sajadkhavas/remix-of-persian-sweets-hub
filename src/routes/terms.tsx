...
export const Route = createFileRoute("/terms")({
  head: () =>
    buildSeo({
      ...
      description:
        "قوانین و شرایط استفاده از خدمات وینیمی بیکری — خرید، ارسال، بازگشت کالا.",
      path: "/terms",
    }),
  component: TermsPage,
});
      ...
      <RevealOnScroll>
        <article className="mx-auto max-w-3xl rounded-3xl bg-white p-8 md:p-10 border border-border">
          ...
          <div className="legal-content mt-6">
            ...
            <p>
              با ثبت سفارش در وبسایت {SITE.brandFa} ({SITE.domain})، کاربر موافقت خود را با
              تمامی شرایط و مقررات این صفحه اعلام می‌کند. {SITE.brandFa} حق دارد در هر زمان
              این شرایط را بدون اطلاع قبلی تغییر دهد.
            </p>
            ...
            <ul>
              ...
              <li>موجودی محصولات محدود و روزانه پخته می‌شود. در صورت ناموجودی، با خریدار تماس گرفته می‌شود.</li>
            </ul>
            ...
            <h2>۶. مسئولیت‌ها</h2>
            <ul>
              <li>{SITE.brandFa} مسئولیت صحت اطلاعات محصولات (مواد اولیه، ماندگاری) را می‌پذیرد.</li>
