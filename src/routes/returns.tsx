...
export const Route = createFileRoute("/returns")({
  head: () =>
    buildSeo({
      ...
      description: "شرایط بازگشت و مبادله محصولات وینیمی بیکری — ضمانت سالم رسیدن.",
      path: "/returns",
    }),
...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "خیر. محصولات مواد غذایی پس از باز شدن، به دلایل بهداشتی قابل بازگشت نیستند.",
  },
];
      ...
      <RevealOnScroll>
        <article className="mx-auto max-w-3xl rounded-3xl bg-white p-8 md:p-10 border border-border">
          ...
          <div className="legal-content mt-6">
            ...
            <p>
              {SITE.brandFa} ضمانت می‌دهد که تمام محصولات سالم، تازه و طبق توضیحات سایت به دستتان
              برسند.
            </p>
            ...
            <ul>
              <li>
                <strong>مرحله ۱:</strong> تصویر محصول معیوب را به واتساپ ما ارسال کنید
              </li>
              <li>
                <strong>مرحله ۲:</strong> کارشناس ما ظرف ۲۴ ساعت بررسی و تأیید می‌کند
              </li>
              <li>
                <strong>مرحله ۳:</strong> محصول جایگزین ارسال یا هزینه بازپرداخت می‌شود
              </li>
            </ul>
